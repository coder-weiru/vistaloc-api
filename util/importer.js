...
var SampleGroups = [
  ...
  {
    name: 'clientGroup',
    description: 'Cognito user group for vistaloc users',
    precedence: 1,
  ...
  generateSampleData() {
    return Promise.all([
      ...
      this.generateSampleLocation('The Venetian', 'Las Vegas',
        'https://s3.amazonaws.com/vistaloc-public-image-repository/venetian.jpg')
        .then(locationId => {
      ...
      this.generateSampleLocation('Encore', 'Las Vegas',
        'https://s3.amazonaws.com/vistaloc-public-image-repository/encore.jpg')
        .then(locationId => {
      ...
      this.generateSampleLocation('The Mirage', 'Las Vegas',
        'https://s3.amazonaws.com/vistaloc-public-image-repository/mirage.jpg')
        .then(locationId => {
