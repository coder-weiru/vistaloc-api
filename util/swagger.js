...
let appSdkDir = path.join(__dirname,'..','..','app','src','services','vistaloc-sdk');
...
function createSdk() {
  ...
  return new Promise((resolve, reject) => {
    ...
    let cmd = spawn('swagger-codegen', ['generate', '-i', swaggerDir + '/vistaloc-api-exported.yml', '-l', 'typescript-angular2', '-o', apiSdkDir]);
